...
export class HomePage {
  ...
  constructor(private router: Router, public navCtrl: NavController, public toastController: ToastController, public authService: AuthService, public http: HttpClient, public platform: Platform) {
    try {
  ...
  openproduct2(index) {
    ...
    this.router.navigate(['/product-details', { product_id: this.product[index].product_id, product_name: this.product[index].product_name }]);
  }
  
  // openproduct3(index) {
  //   console.log(this.special[index].product_id);
  //   this.router.navigate(['/product-details', { product_id: this.special[index].product_id, product_name: this.special[index].product_name }]);
  // }
