    ...
    constructor(public camera:Camera ,
      ...
      private route: ActivatedRoute) {
        this.route.params.subscribe(params => {
          this.CatData.cat_name = params['cat_name']; 
          this.CatData.cat_id = params['cat_id'];
          this.CatData.cat_image = params['cat_image'];
      ...
      this.authService.postDate(this.CatData, 'updatecat').then((result) => {
